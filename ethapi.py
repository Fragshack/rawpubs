#ethpit.py Mizogg 07/08/2021 mizogg.co.uk Random Scan for ETH Addresses and Transactions Made by mizogg.co.uk
...
def seek(r):
    while True:
        api1="?apiKey=EK-6E1La-cuWawLG-bGL9w"
        api2="?apiKey=EK-sw1Kr-Skf8UQf-muLGS"
        #api3="?apiKey=freekey"
        #api4="?apiKey=freekey"
        #api5="?apiKey=freekey"
        #api6="?apiKey=freekey"
        ...
        print ( 'Ethereum Address    :  '  + ethadd +  ' : TX = '  +  str(balance), end='\r')
        if int(balance) > 0:
